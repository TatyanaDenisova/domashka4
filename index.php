    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for ($i = 0; $i < count($jobs); $i++): ?>
            <div class="w3-container">
              <h5 class="w3-opacity"><b> <?php echo $jobs[$i]['job_name']; ?></b></h5>
              <h6 class="w3-text-teal">
                  <i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $jobs[$i]['date_start']; ?> -
                  <?php if ($jobs[$i]['date_end'] == 'Current'):?>
                  <span
                    class="w3-tag w3-teal w3-round"> <?= $jobs[$i]['date_end'] ?></span>
                  <?php else: ?>
                  <?= $jobs[$i]['date_end'] ?>
                  <?php endif;?>
                  </h6>
